...
<div class="vlt-navbar-contacts"><a href="tel:+72126742510">+234 8108506562</a></div>
...
<h1 class="vlt-large-heading">eMiracle<span class="has-accent-color">.</span></h1>
</div>
<div class="vlt-gap-15"></div>
...
<div class="vlt-animated-block" data-animation-name="fadeInUpSm" style="animation-delay:0s; animation-duration:700ms;">
<div class="vlt-experience-block"><span class="vlt-experience-block__number">5<span class="has-accent-color">+</span></span>
<h5 class="vlt-experience-block__title">Years<br>Experience<br>Providing <br> Solutions</h5>
</div>
</div>
...
<div class="vlt-animated-block" data-animation-name="fadeInUpSm" style="animation-delay:.2s; animation-duration:700ms;">
<p>Here is a sneak peak into what i can do.</p>
</div>
...
<div class="vlt-progress-bar" data-final-value="82" data-animation-speed="1000">
<h5 class="vlt-progress-bar__title">MySQL<span class="counter">0</span>
</h5>
<div class="vlt-progress-bar__bar"><span></span></div>
</div>
</div>
...
<div class="vlt-progress-bar" data-final-value="87" data-animation-speed="1000">
<h5 class="vlt-progress-bar__title">Laravel<span class="counter">0</span>
</h5>
<div class="vlt-progress-bar__bar"><span></span></div>
</div>
</div>
 ...
 <div class="vlt-animated-block" data-animation-name="fadeInUpSm" style="animation-delay:.5s; animation-duration:700ms;">
  ...
  <div class="vlt-progress-bar" data-final-value="81" data-animation-speed="1000">
   <h5 class="vlt-progress-bar__title">REST API<span class="counter">0</span>
   </h5>
   <div class="vlt-progress-bar__bar"><span></span></div>
  </div>
 </div>
...
</script><script src="assets/vendors/jquery-3.5.1.min.js"></script>
  ...
  $('form.myForm').on('submit', function(){
   ...
   $.ajax({
    ...
    success: function(response) {
     //put the reponse in my alert div
